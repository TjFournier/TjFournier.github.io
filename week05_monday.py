...
german = 'Strauß' #length can change between upper and lower case

numbers = '৪৭' # In Tamil ৪ = 4 , ৭ = 7

url1 = 'https://www.BankOfAmerica.com' #None of these are the same
url2 = 'https://www.ΒankΟfΑmerica.com'
url3 = 'https://www.BankOf​America.com'

greek = 'αβγδεζηθικλμνξοπρςστυφχψ'

empty = '​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​' #This has 42 characters contained
...
bytes1 = 'hello world'.encode('utf-8') #nice property that for english letters, ASCII values are represented exactly with the decimal collum
